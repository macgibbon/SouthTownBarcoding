...
public class EditProductDialog {
    ...
    public EditProductDialog( Map<Integer, ProductId> productIdMap, Window owner) {
        super();
        dialog = new Dialog<>();
        dialog.initOwner(owner);
        dialog.setTitle("Edit Product Worksheet");
        dialog.setHeaderText("Edit the appropriate text.");
